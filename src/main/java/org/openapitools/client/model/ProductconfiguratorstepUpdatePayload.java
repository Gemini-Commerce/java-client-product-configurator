...
public class ProductconfiguratorstepUpdatePayload {
   ...
   * @return the ProductconfiguratorstepUpdatePayload instance itself
   */
  public ProductconfiguratorstepUpdatePayload putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, productconfiguratorstepUpdatePayload.label) &&
        ...
        Objects.equals(this.additionalProperties, productconfiguratorstepUpdatePayload.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, description, position, isRequired, subjectToStepId, hasMultipleSelection, optionsHaveQuantity, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductconfiguratorstepUpdatePayload>() {
           ...
           public ProductconfiguratorstepUpdatePayload read(JsonReader in) throws IOException {
             ...
             ProductconfiguratorstepUpdatePayload instance = thisAdapter.fromJsonTree(jsonObj);
