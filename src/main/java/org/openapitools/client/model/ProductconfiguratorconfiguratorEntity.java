...
public class ProductconfiguratorconfiguratorEntity {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, grn, productId, label, status, steps, createdAt, updatedAt);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductconfiguratorconfiguratorEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductconfiguratorconfiguratorEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
