...
import org.openapitools.client.model.ConfigurationConfigurationStep;
...
public class ConfigurationGetConfigurationFromSelectionsResponse {
  ...
  public ConfigurationGetConfigurationFromSelectionsResponse steps(List<ConfigurationConfigurationStep> steps) {
    this.steps = steps;
    return this;
  }

  public ConfigurationGetConfigurationFromSelectionsResponse addStepsItem(ConfigurationConfigurationStep stepsItem) {
    if (this.steps == null) {
  ...
  public void setSteps(List<ConfigurationConfigurationStep> steps) {
    this.steps = steps;
  }


  public ConfigurationGetConfigurationFromSelectionsResponse matchedProperties(List<ConfigurationProperty> matchedProperties) {
    this.matchedProperties = matchedProperties;
    return this;
  }

  public ConfigurationGetConfigurationFromSelectionsResponse addMatchedPropertiesItem(ConfigurationProperty matchedPropertiesItem) {
      ...
      if (jsonObj.get("steps") != null && !jsonObj.get("steps").isJsonNull()) {
        ...
        if (jsonArraysteps != null) {
          ...
          for (int i = 0; i < jsonArraysteps.size(); i++) {
            ConfigurationConfigurationStep.validateJsonElement(jsonArraysteps.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigurationGetConfigurationFromSelectionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigurationGetConfigurationFromSelectionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigurationGetConfigurationFromSelectionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigurationGetConfigurationFromSelectionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigurationGetConfigurationFromSelectionsResponse>() {
           @Override
