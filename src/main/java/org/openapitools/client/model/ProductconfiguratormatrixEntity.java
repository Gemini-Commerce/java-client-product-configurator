...
public class ProductconfiguratormatrixEntity {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, grn, configuratorId, label, defaultPropertyId, propertiesMode, genericType, priceType, weightType, steps, createdAt, updatedAt);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductconfiguratormatrixEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductconfiguratormatrixEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
